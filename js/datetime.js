...
function isDaytime(latlon) {
	...
	var lon = latlon.substring(latlon.indexOf(",") + 1, latlon.length);
	//alert("lat: " + lat + " lon: " + lon);

	var currLoc = new SunriseSunset(year, month, date, lat, lon);
	var isDaylight = currLoc.isDaylight(hours);
	return isDaylight;
}

//   SunriseSunset Class (2013-02-12)
//
// OVERVIEW
//
